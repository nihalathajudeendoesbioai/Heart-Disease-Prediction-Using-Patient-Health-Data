...
10. Documentation (README, PPT, GitHub)# Heart-Disease-Prediction-Using-Patient-Health-Data
Predicting heart disease using patient health data (KNN, Logistic Regression, Gradient Boosting)
